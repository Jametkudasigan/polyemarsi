...
🟢 BUY:  Price > EMA21, EMA9 > EMA21, RSI turun ke 35-40 lalu mantul naik, candle naik
🔴 SELL: Price < EMA21, EMA9 < EMA21, RSI naik ke 60-65 lalu turun, candle turun
"""
import os
import sys
import time
...
class BTC5mBot:
    ...
    def run(self):
        console.print(Panel(
            ...
            "[dim]Strategy: EMA 9/21 + RSI 14 Bounce[/dim]",
            border_style="blue",
            box=box.DOUBLE,
            padding=(1, 4)
        ))
